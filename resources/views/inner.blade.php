                            ...
                            <div class="p-b-70">
                                ...
                                <div class="flex-wr-s-s p-b-40">
                                    <span class="f1-s-3 cl8 m-r-15">
                                        ...
                                        <span>
                                            Jul 22, 2023 01:20 PM
                                        </span>
                                    </span>
                                </div>

                                <div class="wrap-pic-max-w p-b-30">
                                    <img src="{{asset('assets')}}/images/blog-list-04.jpg" class="rounded img-fluid" alt="IMG">
                                </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="m-b-30">
                                            <div class="card border-0 shadow-sm mb-3">
                                                <div class="card-body">
                                                    <a href="javascript:void();" class="wrap-pic-w hov1 trans-03">
                                                        <img src="{{asset('assets')}}/images/post-06.jpg" alt="IMG" class="img-fluid rounded">
                                                    </a>
                                                    <div class="p-t-20">
                                                        <h5 class="p-b-5">
                                                            <a href="javascript:void();" class="f1-s-5 cl2 hov-cl10 trans-03">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="m-b-30">
                                            <div class="card border-0 shadow-sm mb-3">
                                                <div class="card-body">
                                                    <a href="javascript:void();" class="wrap-pic-w hov1 trans-03">
                                                        <img src="{{asset('assets')}}/images/post-38.jpg" alt="IMG" class="img-fluid rounded">
                                                    </a>
                                                    <div class="p-t-20">
                                                        <h5 class="p-b-5">
                                                            <a href="javascript:void();" class="f1-s-5 cl2 hov-cl10 trans-03">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="m-b-30">
                                            <div class="card border-0 shadow-sm mb-3">
                                                <div class="card-body">
                                                    <a href="javascript:void();" class="wrap-pic-w hov1 trans-03">
                                                        <img src="{{asset('assets')}}/images/post-12.jpg" alt="IMG" class="img-fluid rounded">
                                                    </a>
                                                    <div class="p-t-20">
                                                        <h5 class="p-b-5">
                                                            <a href="javascript:void();" class="f1-s-5 cl2 hov-cl10 trans-03">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="m-b-30">
                                            <div class="card border-0 shadow-sm mb-3">
                                                <div class="card-body">
                                                    <a href="javascript:void();" class="wrap-pic-w hov1 trans-03">
                                                        <img src="{{asset('assets')}}/images/post-14.jpg" alt="IMG" class="img-fluid rounded">
                                                    </a>
                                                    <div class="p-t-20">
                                                        <h5 class="p-b-5">
                                                            <a href="javascript:void();" class="f1-s-5 cl2 hov-cl10 trans-03">
