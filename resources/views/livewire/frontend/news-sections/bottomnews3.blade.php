<div class="col-sm-4 p-b-25">
    ...
    <!-- Main Item post -->
    @if (session()->get('language') == "hindi" )
        @forelse ($seven_CatWise_HindiNews  as $key => $cat_Hin_News )
            @if($key  == 0 )
             <div class="mb-3">
...
{{--======================== english news ======================== --}}
 ...
 @if (session()->get('language') == "english" )
    ...
    @forelse ($seven_CatWise_EngNews  as $key => $cat_eng_News )
        @if($key  == 0 )
            <div class="mb-3">
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body">
...
{{--======================== punjabi news ======================== --}}
 ...
 @if (session()->get('language') == "punjabi" )
    ...
    @forelse ($seven_CatWise_PbiNews  as $key => $cat_Pbi_News )
        @if($key  == 0 )
            <div class="mb-3">
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body">
...
{{--======================== urdu news ======================== --}}
 @if (session()->get('language') == "urdu" )
    @forelse ($seven_CatWise_UrduNews  as $key => $cat_urdu_News )
        @if($key  == 0 )
            <div class="mb-3">
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body">
