...
class ThirdCategoryNews extends Component
{
    ...
    public function render()
    {
        ...
        $getMenus = Cache::remember('third_category_news_menus', now()->addMinutes(5), function () {
        ...
        $third_Cat_Wise_News = Cache::remember('third_category_news_posts_' . $this->languageVal, now()->addMinutes(5), function () use ($categoryIds) {
