...
class SideForthCatNews extends Component
{
    ...
    public function render()
    {
        ...
        $getMenus = Cache::remember('forth_category_news_menus', now()->addMinutes(1), function () {
        ...
        $fourthCatWise_News = Cache::remember('forth_category_news_posts_' . $this->languageVal, now()->addMinutes(1), function () use ($categoryIds) {
